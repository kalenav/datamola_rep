function createCalendar(elem, year, month) {
    ...
    const startsAt = Math.floor(1 + Math.floor(2.6 * ((month + 9) % 12 + 1) - 0.2) - C + Y + Math.floor(Y / 4) + Math.floor(C / 4)) % 7; // https://cs.uwaterloo.ca/~alopez-o/math-faq/node73.html
    let monthLength;
